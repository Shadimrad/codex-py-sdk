...
from codex_app_server.errors import InvalidParamsError, JsonRpcError, MethodNotFoundError, ServerBusyError
...
with AppServerClient() as client:
    ...
    result = retry_on_overload(
        lambda: client.run_text_turn(thread_id, "Summarize retry best practices in 3 bullets."),
        max_attempts=3,
